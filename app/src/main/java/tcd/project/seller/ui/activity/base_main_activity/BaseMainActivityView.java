...
import tcd.project.seller.ui.activity.base_main_activity.BaseMainActivityViewCallback;
import tcd.project.seller.ui.activity.base_main_activity.BaseMainActivityViewInterface;
...
public class BaseMainActivityView extends BaseView<BaseMainActivityView.UIContainer> implements BaseMainActivityViewInterface {
    ...
    public void reloadMenuNavigation() {
        ...
        if (userResponseModel != null) {
            ui.bnb_menu_control.setTitleItem(4,userResponseModel.getCustomer_name());
        } else {

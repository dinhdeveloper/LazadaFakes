package tcd.project.seller.ui.fragment.list_import;
...
public class FragmentListProductImportView extends BaseView<FragmentListProductImportView.UIContainer> implements FragmentAdminManagerListBaseViewInterface {

    private HomeActivity activity;
    private FragmentAdminManagerListBaseViewCallback callback;
    private ListProductImportAdapter productImportAdapter;
...
//                        orderManagerAdapter.notifyDataSetChanged();
    ...
    private void setUpListData() {
        ...
        productImportAdapter = new ListProductImportAdapter(getContext(), listDatas);

        recyclerAdapterWithHF = new RecyclerAdapterWithHF(productImportAdapter);
...
//        listDatas.addAll(Arrays.asList(arrDatas));
        ProductImportModel[] arrOrder = (ProductImportModel[]) arrDatas.getData();

        for (ProductImportModel itemOrderModel : arrOrder) {
...
//        orderManagerAdapter.notifyDataSetChanged();
    ...
    public BaseUiContainer getUiContainer() {
        return new FragmentListProductImportView.UIContainer();
    }
